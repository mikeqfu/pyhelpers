...
project = 'pyhelpers'
copyright = '2019-{}, {}'.format(datetime.datetime.now().year, pyhelpers.__author__)
...
html_theme = 'sphinxdoc'  # or 'sphinx_rtd_theme', 'default', 'nature', ...
...
man_pages = [
    ('index',  # startdocname
     'pyhelpers',  # name
     'PyHelpers Documentation',  # description
     ['Qian Fu'],  # authors
     1  # section
     )
]
